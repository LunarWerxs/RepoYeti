 ...
 * `fetch_all_*` (the owner's whole inventory, by name, including repos outside this share),
 * `automation_run_*` (same reason, plus the run's own counters state how many repositories exist
 * outside this share), `auto_update_*`, `operational_error_changed` — all owner-plane.
