 ...
 * arguments (requestWebhookVerdict below; wire contract in docs/APPROVAL_WEBHOOK.md). A webhook
 * verdict writes no receipt: the service's own log is the record for that mode.
 */
